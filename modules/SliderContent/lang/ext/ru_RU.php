...
$lang['postinstall'] = 'Убедитесь, что вы установили права "Modify SliderContent" для тех пользователей, кто должен администрировать материалы.';
